...
from ..rx_create import rx_create, rx_from
...
def rx_window(observable: Observable, buffer_size: int) -> Observable:
    ...
    async def _subscribe(an_observer: Observer) -> Subscription:
        ...
        return observable.subscribe(observer(on_next=_on_next, on_completed=an_observer.on_completed, on_error=an_observer.on_error))
